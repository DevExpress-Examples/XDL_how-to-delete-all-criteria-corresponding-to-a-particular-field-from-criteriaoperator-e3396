...
'ORIGINAL LINE: this.radioGroup1.EditValueChanged += new System.EventHandler(this.OnRemoveFieldChanged);
			' 
			' simpleButton1
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.simpleButton1.Click += new System.EventHandler(this.OnApplyFilter);
			' 
			' simpleButton2
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.simpleButton2.Click += new System.EventHandler(this.OnRemoveCriteriaByField);
			' 
			' Main
			' 
