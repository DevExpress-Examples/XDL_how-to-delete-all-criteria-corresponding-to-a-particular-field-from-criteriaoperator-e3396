...
'INSTANT VB NOTE: The field visitor was renamed since Visual Basic does not allow fields to have the same name as other class members:
		Private visitor_Renamed As RemoveCriteriaVisitor
