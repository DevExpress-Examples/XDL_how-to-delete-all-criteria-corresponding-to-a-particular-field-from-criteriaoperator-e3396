...
Namespace DXSample
	...
	Public Class RemoveCriteriaVisitor
		...
		Public Function Visit(ByVal theOperator As FunctionOperator) As Object Implements DevExpress.Data.Filtering.ICriteriaVisitor.Visit
		...
		Public Function Visit(ByVal theOperand As OperandValue) As Object Implements DevExpress.Data.Filtering.ICriteriaVisitor.Visit
			Return theOperand
		End Function

		Public Function Visit(ByVal theOperator As GroupOperator) As Object Implements DevExpress.Data.Filtering.ICriteriaVisitor.Visit
			Dim operators As New List(Of CriteriaOperator)()
			For Each op As CriteriaOperator In theOperator.Operands
				Dim temp As CriteriaOperator = TryCast(op.Accept(Me), CriteriaOperator)
				If Object.ReferenceEquals(temp, Nothing) Then
		...
		Public Function Visit(ByVal theOperator As InOperator) As Object Implements DevExpress.Data.Filtering.ICriteriaVisitor.Visit
		...
		Public Function Visit(ByVal theOperator As UnaryOperator) As Object Implements DevExpress.Data.Filtering.ICriteriaVisitor.Visit
		...
		Public Function Visit(ByVal theOperator As BinaryOperator) As Object Implements DevExpress.Data.Filtering.ICriteriaVisitor.Visit
			Dim leftOperand As CriteriaOperator = TryCast(theOperator.LeftOperand.Accept(Me), CriteriaOperator)
		...
		Public Function Visit(ByVal theOperator As BetweenOperator) As Object Implements DevExpress.Data.Filtering.ICriteriaVisitor.Visit
