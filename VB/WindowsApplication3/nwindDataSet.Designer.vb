...
Namespace DXSample
    ...
    Public Partial Class nwindDataSet
        ...
        Private tableEmployees As DXSample.nwindDataSet.EmployeesDataTable
        ...
        Protected Sub New(ByVal info As Global.System.Runtime.Serialization.SerializationInfo, ByVal context As Global.System.Runtime.Serialization.StreamingContext)
            ...
            If(Me.DetermineSchemaSerializationMode(info, context) = Global.System.Data.SchemaSerializationMode.IncludeSchema) Then
                ...
                If(ds.Tables("Employees") IsNot Nothing) Then
                    MyBase.Tables.Add(New DXSample.nwindDataSet.EmployeesDataTable(ds.Tables("Employees")))
                End If
        ...
        Friend Sub InitVars(ByVal initTable As Boolean)
            Me.tableEmployees = CType((MyBase.Tables("Employees")), DXSample.nwindDataSet.EmployeesDataTable)
        ...
        Private Sub InitClass()
            ...
            Me.tableEmployees = New DXSample.nwindDataSet.EmployeesDataTable()
        ...
        Public Delegate Sub EmployeesRowChangeEventHandler(ByVal sender As Object, ByVal e As DXSample.nwindDataSet.EmployeesRowChangeEvent)
        ...
        Public Partial Class EmployeesDataTable
            ...
            Default Public ReadOnly Property Item(ByVal index As Integer) As EmployeesRow
                Get
                    Return CType((Me.Rows(index)), DXSample.nwindDataSet.EmployeesRow)
                End Get
            End Property

            Public Event EmployeesRowChanging As DXSample.nwindDataSet.EmployeesRowChangeEventHandler

            Public Event EmployeesRowChanged As DXSample.nwindDataSet.EmployeesRowChangeEventHandler

            Public Event EmployeesRowDeleting As DXSample.nwindDataSet.EmployeesRowChangeEventHandler

            Public Event EmployeesRowDeleted As DXSample.nwindDataSet.EmployeesRowChangeEventHandler

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            Public Sub AddEmployeesRow(ByVal row As DXSample.nwindDataSet.EmployeesRow)
                Me.Rows.Add(row)
            End Sub

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            Public Function AddEmployeesRow(ByVal FirstName As String, ByVal Title As String, ByVal BirthDate As System.DateTime, ByVal City As String, ByVal Region As String, ByVal Country As String) As EmployeesRow
                Dim rowEmployeesRow As DXSample.nwindDataSet.EmployeesRow = CType((Me.NewRow()), DXSample.nwindDataSet.EmployeesRow)
                Dim columnValuesArray As Object() = New Object() {Nothing, FirstName, Title, BirthDate, City, Region, Country}
            ...
            Public Function FindByEmployeeID(ByVal EmployeeID As Integer) As EmployeesRow
                Return CType((Me.Rows.Find(New Object() {EmployeeID})), DXSample.nwindDataSet.EmployeesRow)
            End Function
            ...
            Public Overrides Function Clone() As Global.System.Data.DataTable
                Dim cln As DXSample.nwindDataSet.EmployeesDataTable = CType((MyBase.Clone()), DXSample.nwindDataSet.EmployeesDataTable)
                cln.InitVars()
                Return cln
            End Function
            ...
            Protected Overrides Function CreateInstance() As Global.System.Data.DataTable
                Return New DXSample.nwindDataSet.EmployeesDataTable()
            End Function
            ...
            Public Function NewEmployeesRow() As EmployeesRow
                Return CType((Me.NewRow()), DXSample.nwindDataSet.EmployeesRow)
            End Function

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            Protected Overrides Function NewRowFromBuilder(ByVal builder As Global.System.Data.DataRowBuilder) As Global.System.Data.DataRow
                Return New DXSample.nwindDataSet.EmployeesRow(builder)
            End Function

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            Protected Overrides Function GetRowType() As Global.System.Type
                Return GetType(DXSample.nwindDataSet.EmployeesRow)
            End Function

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            Protected Overrides Sub OnRowChanged(ByVal e As Global.System.Data.DataRowChangeEventArgs)
                MyBase.OnRowChanged(e)
                RaiseEvent EmployeesRowChanged(Me, New DXSample.nwindDataSet.EmployeesRowChangeEvent(CType((e.Row), DXSample.nwindDataSet.EmployeesRow), e.Action))
            End Sub

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            Protected Overrides Sub OnRowChanging(ByVal e As Global.System.Data.DataRowChangeEventArgs)
                MyBase.OnRowChanging(e)
                RaiseEvent EmployeesRowChanging(Me, New DXSample.nwindDataSet.EmployeesRowChangeEvent(CType((e.Row), DXSample.nwindDataSet.EmployeesRow), e.Action))
            End Sub

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            Protected Overrides Sub OnRowDeleted(ByVal e As Global.System.Data.DataRowChangeEventArgs)
                MyBase.OnRowDeleted(e)
                RaiseEvent EmployeesRowDeleted(Me, New DXSample.nwindDataSet.EmployeesRowChangeEvent(CType((e.Row), DXSample.nwindDataSet.EmployeesRow), e.Action))
            End Sub

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            Protected Overrides Sub OnRowDeleting(ByVal e As Global.System.Data.DataRowChangeEventArgs)
                MyBase.OnRowDeleting(e)
                RaiseEvent EmployeesRowDeleting(Me, New DXSample.nwindDataSet.EmployeesRowChangeEvent(CType((e.Row), DXSample.nwindDataSet.EmployeesRow), e.Action))
            End Sub

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            Public Sub RemoveEmployeesRow(ByVal row As DXSample.nwindDataSet.EmployeesRow)
                Me.Rows.Remove(row)
            End Sub
        ...
        Public Partial Class EmployeesRow
            ...
            Friend Sub New(ByVal rb As Global.System.Data.DataRowBuilder)
                MyBase.New(rb)
                Me.tableEmployees = CType((Me.Table), DXSample.nwindDataSet.EmployeesDataTable)
            End Sub
        ...
        Public Class EmployeesRowChangeEvent
            ...
            Private eventRow As DXSample.nwindDataSet.EmployeesRow

            Private eventAction As Global.System.Data.DataRowAction

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            Public Sub New(ByVal row As DXSample.nwindDataSet.EmployeesRow, ByVal action As Global.System.Data.DataRowAction)
                Me.eventRow = row
...
Namespace DXSample.nwindDataSetTableAdapters
    ...
    Public Partial Class EmployeesTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT EmployeeID, FirstName, Title, BirthDate, City, Region, Country FROM Employ" & "ees"
        ...
        Public Overridable Function Fill(ByVal dataTable As DXSample.nwindDataSet.EmployeesDataTable) As Integer
        ...
        Public Overridable Function GetData() As DXSample.nwindDataSet.EmployeesDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DXSample.nwindDataSet.EmployeesDataTable = New DXSample.nwindDataSet.EmployeesDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
        <Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(ByVal dataTable As DXSample.nwindDataSet.EmployeesDataTable) As Integer
        ...
        Public Overridable Function Delete(ByVal Original_EmployeeID As Integer, ByVal Original_FirstName As String, ByVal Original_Title As String, ByVal Original_BirthDate As Global.System.Nullable(Of Global.System.DateTime), ByVal Original_City As String, ByVal Original_Region As String, ByVal Original_Country As String) As Integer
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((2))).Value =(CStr((Original_FirstName)))
            End If
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((4))).Value =(CStr((Original_Title)))
            End If

            If(Original_BirthDate.HasValue = True) Then
                Me.Adapter.DeleteCommand.Parameters(CInt((5))).Value =(CObj((0)))
                Me.Adapter.DeleteCommand.Parameters(CInt((6))).Value =(CDate((Original_BirthDate.Value)))
            Else
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((8))).Value =(CStr((Original_City)))
            End If
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((10))).Value =(CStr((Original_Region)))
            End If
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((12))).Value =(CStr((Original_Country)))
            End If
        ...
        Public Overridable Function Update(ByVal FirstName As String, ByVal Title As String, ByVal BirthDate As Global.System.Nullable(Of Global.System.DateTime), ByVal City As String, ByVal Region As String, ByVal Country As String, ByVal Original_EmployeeID As Integer, ByVal Original_FirstName As String, ByVal Original_Title As String, ByVal Original_BirthDate As Global.System.Nullable(Of Global.System.DateTime), ByVal Original_City As String, ByVal Original_Region As String, ByVal Original_Country As String) As Integer
            If(Equals(FirstName, Nothing)) Then
                Throw New Global.System.ArgumentNullException("FirstName")
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((0))).Value =(CStr((FirstName)))
            End If

            If(Equals(Title, Nothing)) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((1))).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((1))).Value =(CStr((Title)))
            End If

            If(BirthDate.HasValue = True) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((2))).Value =(CDate((BirthDate.Value)))
            Else
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((3))).Value =(CStr((City)))
            End If

            If(Equals(Region, Nothing)) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((4))).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((4))).Value =(CStr((Region)))
            End If

            If(Equals(Country, Nothing)) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((5))).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((5))).Value =(CStr((Country)))
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((6))).Value =(CInt((Original_EmployeeID)))
            If(Equals(Original_FirstName, Nothing)) Then
                Throw New Global.System.ArgumentNullException("Original_FirstName")
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((7))).Value =(CObj((0)))
                Me.Adapter.UpdateCommand.Parameters(CInt((8))).Value =(CStr((Original_FirstName)))
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((10))).Value =(CStr((Original_Title)))
            End If

            If(Original_BirthDate.HasValue = True) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((11))).Value =(CObj((0)))
                Me.Adapter.UpdateCommand.Parameters(CInt((12))).Value =(CDate((Original_BirthDate.Value)))
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((14))).Value =(CStr((Original_City)))
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((16))).Value =(CStr((Original_Region)))
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((18))).Value =(CStr((Original_Country)))
            End If
